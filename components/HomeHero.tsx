...
export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-[#010501] pt-40 md:pt-68 pb-40 select-none font-normal">
      {/* Floating Leaves */}
      <Image src="/images/Leave3.svg" alt="leaf" width={48} height={48} className="absolute left-72 top-150 w-10 h-10 opacity-80 select-none" draggable="false" onContextMenu={(e) => e.preventDefault()} />
      <Image src="/images/Leave1.svg" alt="leaf" width={66} height={66} className="absolute right-64 top-50 w-20 h-12 opacity-80 select-none" draggable="false" onContextMenu={(e) => e.preventDefault()} />
      <Image src="/images/Leave2.svg" alt="leaf" width={48} height={48} className="absolute left-[31.5%] top-84 w-10 h-10 opacity-60 select-none" draggable="false" onContextMenu={(e) => e.preventDefault()} />
...
<Image src="/images/users.svg" alt="user" width={48} height={48} className="rounded-full w-32 select-none" draggable="false" onContextMenu={(e) => e.preventDefault()} />
        ...
        <div className="mt-20 relative w-full flex justify-center">
          <div
            className="w-[140%] rotate-[-5deg] bg-linear-to-r from-[#C5FF85] to-[#7EFF43] py-6 px-4 flex justify-around text-black font-semibold text-center"
          >
            <div>
      ...
      <div className="absolute right-20 bottom-10 translate-y-10 w-[380px] md:w-[580px]">
        <Image src="/images/Phonetiwi.svg" alt="App Preview" width={48} height={48} className="w-[90rem] object-contain select-none" draggable="false" onContextMenu={(e) => e.preventDefault()} />
      </div>
    </section>
  );
}
