...
export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-[#010501] pt-40 md:pt-68 pb-18 select-none font-normal">
      {/* Floating Leaves */}
      <Image
      ...
      "
        ...
        {/* Bottom Ribbon */}
        <div className="mt-28 relative w-screen flex flex-col justify-center">
          <div className="w-[140%] rotate-[-7deg] bg-linear-to-r from-[#C5FF85] to-[#7EFF43] py-6 px-4 flex text-black font-semibold text-center">
            <div>
          ...
          <div className="w-[140%] rotate-[10deg] bg-linear-to-r from-[#C5FF85] to-[#7EFF43] h-24 px-4 flex text-black font-semibold text-center">
